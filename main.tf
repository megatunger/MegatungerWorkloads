...
variable "HEROKU_ACCOUNT_EMAIL" {
  default = "hoangsontung080899@gmail.com"
}
variable "HEROKU_API_KEY" {}

variable "HEROKU_ACCOUNT_MEGATUNGER_API_KEY" {}
variable "HEROKU_ACCOUNT_MEGATUNGER_EMAIL" {
  default = "megatunger@gmail.com"
}

variable "HEROKU_ACCOUNT_ETRON_TEAM_EMAIL" {
  default = "etronai.team@gmail.com"
}
...
variable "CLOUDFLARE_UCALL_CC_ZONE_ID" {}
variable "CLOUDFLARE_UCALL_ASIA_ZONE_ID" {}
...
module "LuaLepAPI" {
  ...
  HEROKU_ACCOUNT_EMAIL              = var.HEROKU_ACCOUNT_MEGATUNGER_EMAIL
  HEROKU_API_KEY                    = var.HEROKU_ACCOUNT_MEGATUNGER_API_KEY
...
# module "uCallSystemStag" {
#   source = "./uCallSystemStag"

#   HEROKU_ACCOUNT_EMAIL = var.HEROKU_ACCOUNT_ETRON_TEAM_EMAIL
#   HEROKU_API_KEY = var.HEROKU_ACCOUNT_ETRON_TEAM_API_KEY
#   CLOUDFLARE_ACCOUNT_EMAIL = var.CLOUDFLARE_ACCOUNT_EMAIL
#   CLOUDFLARE_API_KEY = var.CLOUDFLARE_API_KEY
#   CLOUDFLARE_ZONE_ID = var.CLOUDFLARE_UCALL_CC_ZONE_ID
#   GITHUB_API_TOKEN = var.GITHUB_API_TOKEN
# }
...
module "uCallSystemProd" {
  ...
  CLOUDFLARE_ACCOUNT_EMAIL = var.CLOUDFLARE_ACCOUNT_EMAIL
  CLOUDFLARE_API_KEY       = var.CLOUDFLARE_API_KEY
  CLOUDFLARE_ZONE_ID       = var.CLOUDFLARE_UCALL_ASIA_ZONE_ID
  GITHUB_API_TOKEN         = var.GITHUB_API_TOKEN
}

module "uCallLandingPage" {
  source = "./uCallLandingPage"
...
module "uCallCloudflare" {
  source = "./uCallCloudflare"

  CLOUDFLARE_ACCOUNT_EMAIL      = var.CLOUDFLARE_ACCOUNT_EMAIL
  CLOUDFLARE_API_KEY            = var.CLOUDFLARE_API_KEY
  CLOUDFLARE_UCALL_ASIA_ZONE_ID = var.CLOUDFLARE_UCALL_ASIA_ZONE_ID
}
